...
public class ChatImageView extends AsyncTask<Object, Integer, Bitmap> {
    ...
    // 取單張圖片
    public ChatImageView(String url, int imageID, int imageSize) {
        this(url, imageID, imageSize, null);
    }

    // 取完圖片後使用傳入的ImageView顯示，適用於顯示多張圖片
    public ChatImageView(String url, int imageID, int imageSize, ImageView imageView) {
        this.url = url;
    ...
    protected Bitmap doInBackground(Object... objects) {
        ...
        jsonObject.addProperty("type", "getImage");
