...
public class ImageTaskUser extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "ImageTaskUser";
    private String url,id_product;
    ...
    // 取單張圖片
    public ImageTaskUser(String url, String id_product, int imageSize) {
        this(url, id_product, imageSize, null);
    }

    // 取完圖片後使用傳入的ImageView顯示，適用於顯示多張圖片
    public ImageTaskUser(String url, String id_product, int imageSize, ImageView imageView) {
        this.url = url;
